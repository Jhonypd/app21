   ...
   useEffect(() => {
      if (mode === 'single') {
         ...
         if (from && isValid(from)) {
            ...
            const formattedTo =
               to && isValid(to) ? format(to, 'dd/MM/yyyy') : '';
            setInputValue(
               formattedTo
               ...
               <PopoverTrigger asChild>
                  <div className="relative w-full">
                     <input
                        ...
                        className={cn(
                           'peer bg-background max-h-[46px] w-full cursor-pointer rounded-md py-3 pr-4 pl-11 transition-all duration-200 placeholder:text-gray-400 focus:outline-none focus-visible:ring-2',
                           error
                     ...
                     {label && (
                        <label
                           ...
                           className={cn(
                              ...
                              shouldLabelBeOnTop
                                 ? 'bg-background -top-2 z-10 px-1 text-xs text-gray-500'
               ...
               >
                  ...
                  <div className="mb-2 flex w-full items-center justify-center">
                     <Button
                        ...
                        className="border-primary text-primary hover:bg-primary/10 hover:text-primary cursor-pointer uppercase"
                     >
                        Confirmar
                     </Button>
                  </div>
