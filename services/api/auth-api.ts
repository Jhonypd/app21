...
export const AuthApi = apiSlice.injectEndpoints({
   endpoints: (builder) => ({
      login: builder.mutation<ApiResponse<ResponseLogin>, LoginPayload>({
         query: (credentials) => ({
            url: '/auth/login',
            method: 'POST',
            body: credentials,
      ...
      novoCodigo: builder.mutation<ApiResponse, NovoCodigoPayload>({
         query: (email) => ({
            url: '/auth/novoCodigo',
            method: 'POST',
            body: email,
      ...
      redefinirSenha: builder.mutation<ApiResponse, RedefinirSenhaPayload>({
         query: (payload) => ({
