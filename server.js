...
const currentPort = parseInt(process.env.PORT, 10) || 3004;
...
const nextConfig = {
   ...
   outputFileTracingRoot:
      'C:\\Users\\OKEA\\OneDrive\\Documentos\\jhony\\app21-web',
   allowedDevOrigins: ['192.168.0.102', '*.local-origin.dev'],
   ...
   turbopack: {
      root: 'C:\\Users\\OKEA\\OneDrive\\Documentos\\jhony\\app21-web',
   },
   distDirRoot: '.next',
};
